 ...
 * will pay for the corresponding charges. For information about downloading objects from Requester Pays buckets, see
 * Downloading Objects in Requester Pays Buckets [^1] in the *Amazon S3 User Guide*.
 *
