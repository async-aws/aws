...
class SendMessageResult extends Result
{
    ...
    protected function populateResult(ResponseInterface $response, ?HttpClientInterface $httpClient): void
    {
        ...
        $this->MD5OfMessageBody = static::xmlValueOrNull($data->MD5OfMessageBody, 'string');
        $this->MD5OfMessageAttributes = static::xmlValueOrNull($data->MD5OfMessageAttributes, 'string');
        $this->MD5OfMessageSystemAttributes = static::xmlValueOrNull($data->MD5OfMessageSystemAttributes, 'string');
        $this->MessageId = static::xmlValueOrNull($data->MessageId, 'string');
        $this->SequenceNumber = static::xmlValueOrNull($data->SequenceNumber, 'string');
    }
}
