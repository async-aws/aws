...
class ListTagsForResourceOutputTest extends TestCase
{
    public function testListTagsForResourceOutput(): void
    {
        ...
        $result = new ListTagsForResourceOutput(new Response($client->request('POST', 'http://localhost'), $client, new NullLogger()));
