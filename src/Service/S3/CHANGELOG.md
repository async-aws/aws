...
- AWS bugfix: Fixes a bug with checksum calculation of CRC32 in flexible checksums
- AWS enhancement: Documentation updates for Amazon S3
- AWS bugfix: Removes ACL from bucket creation in S3 Streamwrapper.
- AWS enhancement: Documentation updates for Amazon S3
- AWS api-change: Allow FIPS to be used with path-style URLs.
- AWS enhancement: Updates to ContentMD5 api documentation.
- AWS enhancement: Update to `bucket_endpoint` documentation
- AWS bugfix: Fixes bug where MD5 header is not added for PutObject and UploadPart
- AWS bugfix: Fixes issue with path-style endpoints which resulted in duplicated buckets in request uri path.
