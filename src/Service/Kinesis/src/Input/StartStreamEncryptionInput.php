...
final class StartStreamEncryptionInput extends Input
{
    /**
     ...
     * a fully specified Amazon Resource Name (ARN) to either an alias or a key, or an alias name prefixed by "alias/".You
