...
final class CmfcSettings
{
     ...
     * (AudioGroupId) for audio renditions in the same output group as this video rendition. Default behavior: If you don't
     * specify anything here and for Audio group ID, MediaConvert puts each audio variant in its own audio rendition group
     * and associates it with every video variant. Each value in your list appears in your HLS parent manifest in the
     ...
     * Choose Alternate audio, auto select, default (ALTERNATE_AUDIO_AUTO_SELECT_DEFAULT) to set DEFAULT=YES and
     * AUTOSELECT=YES. Choose this value for only one variant in your output group. Choose Alternate audio, auto select, not
     * default (ALTERNATE_AUDIO_AUTO_SELECT) to set DEFAULT=NO and AUTOSELECT=YES. Choose Alternate Audio, Not Auto Select
