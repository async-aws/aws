...
class DeleteKnowledgeBaseDocumentsResponseTest extends TestCase
{
    public function testDeleteKnowledgeBaseDocumentsResponse(): void
    {
            ...
            "documentDetails": [
                {
                    ...
                    "statusReason": "Deleted successfully",
        ...
        $result = new DeleteKnowledgeBaseDocumentsResponse(
            new Response($client->request('POST', 'http://localhost/knowledgebases/kb-1234567890abcdef/datasources/ds-abcdef1234567890/documents/deleteDocuments'), $client, new NullLogger())
        );
        ...
        self::assertSame(DocumentStatus::DELETING, $detail->getStatus());
        ...
        self::assertSame('Deleted successfully', $detail->getStatusReason());
