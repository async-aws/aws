...
class GetKnowledgeBaseDocumentsResponseTest extends TestCase
{
    public function testGetKnowledgeBaseDocumentsResponse(): void
    {
        ...
        $result = new GetKnowledgeBaseDocumentsResponse(
            new Response($client->request('POST', '/knowledgebases/kb-1234567890abcdef/datasources/ds-abcdef1234567890/documents/getDocuments'), $client, new NullLogger())
        );
