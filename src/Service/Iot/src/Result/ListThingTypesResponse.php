...
class ListThingTypesResponse extends Result implements \IteratorAggregate
{
    ...
    private function populateResultThingTypeMetadata(array $json): ThingTypeMetadata
    {
        return new ThingTypeMetadata([
            ...
            'deprecationDate' => isset($json['deprecationDate']) ? new \DateTimeImmutable((string) $json['deprecationDate']) : null,
            'creationDate' => isset($json['creationDate']) ? new \DateTimeImmutable((string) $json['creationDate']) : null,
        ]);
    }
