    ...
    private function populateResultArrayOfArray(array $json): array
    {
        ...
        foreach ($json as $item) {
            $items[] = new ArrayValue([
                'arrayValues' => empty($item['arrayValues']) ? null : $this->populateResultArrayOfArray($item['arrayValues']),
                'booleanValues' => empty($item['booleanValues']) ? null : $this->populateResultBooleanArray($item['booleanValues']),
                'doubleValues' => empty($item['doubleValues']) ? null : $this->populateResultDoubleArray($item['doubleValues']),
                'longValues' => empty($item['longValues']) ? null : $this->populateResultLongArray($item['longValues']),
                'stringValues' => empty($item['stringValues']) ? null : $this->populateResultStringArray($item['stringValues']),
            ]);
        }
        ...
        foreach ($json as $item) {
            $items[] = new Field([
                'arrayValue' => empty($item['arrayValue']) ? null : new ArrayValue([
                    'arrayValues' => empty($item['arrayValue']['arrayValues']) ? null : $this->populateResultArrayOfArray($item['arrayValue']['arrayValues']),
                    'booleanValues' => empty($item['arrayValue']['booleanValues']) ? null : $this->populateResultBooleanArray($item['arrayValue']['booleanValues']),
                    'doubleValues' => empty($item['arrayValue']['doubleValues']) ? null : $this->populateResultDoubleArray($item['arrayValue']['doubleValues']),
                    'longValues' => empty($item['arrayValue']['longValues']) ? null : $this->populateResultLongArray($item['arrayValue']['longValues']),
                    'stringValues' => empty($item['arrayValue']['stringValues']) ? null : $this->populateResultStringArray($item['arrayValue']['stringValues']),
                ]),
    ...
    private function populateResultUpdateResults(array $json): array
    {
        ...
        foreach ($json as $item) {
            $items[] = new UpdateResult([
                'generatedFields' => empty($item['generatedFields']) ? null : $this->populateResultFieldList($item['generatedFields']),
            ]);
        }
