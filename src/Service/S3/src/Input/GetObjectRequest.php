...
final class GetObjectRequest extends Input
{
     ...
     *   Bucket?: string,
     *   IfMatch?: string|null,
     *   IfModifiedSince?: \DateTimeImmutable|string|null,
     *   IfNoneMatch?: string|null,
     *   IfUnmodifiedSince?: \DateTimeImmutable|string|null,
     *   Key?: string,
     *   Range?: string|null,
     ...
     *   ResponseExpires?: \DateTimeImmutable|string|null,
    ...
    public function request(): Request
    {
        ...
        if (null !== $this->ifModifiedSince) {
            $headers['If-Modified-Since'] = $this->ifModifiedSince->setTimezone(new \DateTimeZone('GMT'))->format(\DateTimeInterface::RFC1123);
        }
        if (null !== $this->ifNoneMatch) {
            $headers['If-None-Match'] = $this->ifNoneMatch;
        }
        if (null !== $this->ifUnmodifiedSince) {
            $headers['If-Unmodified-Since'] = $this->ifUnmodifiedSince->setTimezone(new \DateTimeZone('GMT'))->format(\DateTimeInterface::RFC1123);
        }
        if (null !== $this->range) {
        ...
        if (null !== $this->responseExpires) {
            $query['response-expires'] = $this->responseExpires->setTimezone(new \DateTimeZone('GMT'))->format(\DateTimeInterface::RFC1123);
        }
