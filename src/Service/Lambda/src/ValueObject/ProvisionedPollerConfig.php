...
final class ProvisionedPollerConfig
{
    ...
    /**
     * The maximum number of event pollers this event source can scale up to. For Amazon SQS event source mappings, the
     * accepted range is between 2 and 10,000, with a default of 200. For Amazon MSK and self-managed Apache Kafka event
     * source mappings, the accepted range is between 1 and 2,000, with a default of 200.
     *
     * @var int|null
     */
