...
class PutObjectOutput extends Result
{
    ...
    /**
     * The Base64 encoded, 64-bit `CRC-64NVME` checksum of the object. This header is present if the object was uploaded
     * with the `CRC-64NVME` checksum algorithm, or if it was uploaded without a checksum (and Amazon S3 added the default
     * checksum, `CRC-64NVME`, to the uploaded object). For more information about how checksums are calculated with
     * multipart uploads, see Checking object integrity in the Amazon S3 User Guide [^1].
     *
     ...
     * the same checksum that was specified. For more information, see Checking object integrity [^1] in the *Amazon S3 User
     * Guide*.
     *
     * [^1]: https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html
     *
