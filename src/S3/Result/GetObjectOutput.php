...
class GetObjectOutput extends Result
{
    ...
    protected function populateResult(ResponseInterface $response, ?HttpClientInterface $httpClient): void
    {
        ...
        $this->ContentRange = $headers['Content-Range'] ?? null;
        ...
        $this->TagCount = isset($headers['x-amz-tagging-count']) ? filter_var($headers['x-amz-tagging-count'], \FILTER_VALIDATE_INT) : null;
