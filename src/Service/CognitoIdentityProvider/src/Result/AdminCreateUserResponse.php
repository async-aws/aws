...
class AdminCreateUserResponse extends Result
{
    ...
    protected function populateResult(Response $response): void
    {
        ...
        $this->user = empty($data['User']) ? null : new UserType([
            ...
            'Attributes' => !isset($data['User']['Attributes']) ? null : $this->populateResultAttributeListType($data['User']['Attributes']),
            ...
            'MFAOptions' => !isset($data['User']['MFAOptions']) ? null : $this->populateResultMFAOptionListType($data['User']['MFAOptions']),
        ]);
    }
