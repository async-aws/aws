...
class DetectFacesResponse extends Result
{
    ...
    protected function populateResult(Response $response): void
    {
        ...
        $this->FaceDetails = empty($data['FaceDetails']) ? [] : (function (array $json): array {
            $items = [];
            foreach ($json as $item) {
                $items[] = new FaceDetail([
                    ...
                    'Emotions' => empty($item['Emotions']) ? [] : (function (array $json): array {
                        $items = [];
                        foreach ($json as $item) {
                            $items[] = new Emotion([
                    ...
                    'Landmarks' => empty($item['Landmarks']) ? [] : (function (array $json): array {
                        $items = [];
                        foreach ($json as $item) {
                            $items[] = new Landmark([
                                'Type' => isset($item['Type']) ? (string) $item['Type'] : null,
