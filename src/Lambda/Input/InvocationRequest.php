...
class InvocationRequest
{
    ...
    public function requestHeaders(): array
    {
        ...
        if ($this->InvocationType !== null) $headers["X-Amz-Invocation-Type"] = $this->InvocationType;
        if ($this->LogType !== null) $headers["X-Amz-Log-Type"] = $this->LogType;
        if ($this->ClientContext !== null) $headers["X-Amz-Client-Context"] = $this->ClientContext;
        return $headers;
    }
    ...
    {
        $query = [];
        if ($this->Qualifier !== null) $query["Qualifier"] = $this->Qualifier;
        return $query;
    }
    ...
    {
        $uri = [];
        $uri["FunctionName"] = $this->FunctionName ?? "";return "/2015-03-31/functions/{$uri['FunctionName']}/invocations";
    }
