...
final class XavcHdIntraCbgProfileSettings
{
     ...
     * regardless of the scan type of your input. To create an interlaced output, choose Top field first or Follow, default
     * top. Outputs that you create with this profile are always top field first when they are interlaced. When you create
     * an interlaced output, set your output frame rate to 25 or 29.97.
     *
