...
class SimpleS3ClientTest extends TestCase
{
    ...
    {
        $client = new SimpleS3Client(['region' => 'eu-central-1', 's3PathStyleEndpoint' => true], new Credentials('id', 'secret'), new MockHttpClient());
    ...
    {
        $client = new SimpleS3Client(['region' => 'eu-central-1', 's3PathStyleEndpoint' => true], new NullProvider(), new MockHttpClient());
        $url = $client->getUrl('bucket', 'images/file.jpg');
        self::assertSame('https://s3.eu-central-1.amazonaws.com/bucket/images/file.jpg', $url);
    }
}
