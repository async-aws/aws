...
final class TableDescription
{
     ...
     * - `Backfilling` - Specifies whether the index is currently backfilling. During backfill, `SearchVectors` operations
     ...
     * - `IndexSizeBytes` - The total size of the vector index, in bytes. Amazon DynamoDB updates this value approximately
     *   every six hours. Recent changes might not be reflected in this value.
     * - `ItemCount` - The number of items indexed in the vector index. Amazon DynamoDB updates this value approximately
     *   every six hours. Recent changes might not be reflected in this value.
     *
     * @var VectorIndexDescription[]|null
     */
     ...
     *   VectorIndexes?: array<VectorIndexDescription|array>|null,
     * } $input
     */
    public function __construct(array $input)
    {
        ...
        $this->vectorIndexes = isset($input['VectorIndexes']) ? array_map([VectorIndexDescription::class, 'create'], $input['VectorIndexes']) : null;
    }
