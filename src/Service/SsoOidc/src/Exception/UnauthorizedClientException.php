...
/**
 * Indicates that the client is not currently authorized to make the request. This can happen when a `clientId` is not
 * issued for a public client.
 */
final class UnauthorizedClientException extends ClientException
{
    /**
