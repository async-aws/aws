...
class GetObjectOutputTest extends TestCase
{
    public function testMetadata()
    {
        $headers = [
            'x-amz-id-2' => [
                0 => 'wHaofDPIxs4VoML+wxIjs/V+2Ke0B2bi6vDA6OPJctaYf2XgXJpdXCnuOTL0pPoQ48zMhL+fZXo=',
            ],
            'x-amz-request-id' => [
                0 => '29A72C65D02ED350',
            ],
            'date' => [
                0 => 'Sat, 08 Feb 2020 15:58:09 GMT',
            ],
            'last-modified' => [
                0 => 'Sat, 08 Feb 2020 15:55:28 GMT',
            ],
            'etag' => [
                0 => '"9a0364b9e99bb480dd25e1f0284c8555"',
            ],
            'x-amz-meta-tobias' => [
                0 => 'nyholm',
            ],
