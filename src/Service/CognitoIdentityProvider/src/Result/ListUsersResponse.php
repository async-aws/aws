    ...
    private function populateResultUsersListType(array $json): array
    {
        ...
        foreach ($json as $item) {
            $items[] = new UserType([
                ...
                'Attributes' => empty($item['Attributes']) ? null : $this->populateResultAttributeListType($item['Attributes']),
                ...
                'MFAOptions' => empty($item['MFAOptions']) ? null : $this->populateResultMFAOptionListType($item['MFAOptions']),
            ]);
        }
