    ...
    private function populateResultSecretListType(array $json): array
    {
        ...
        foreach ($json as $item) {
            $items[] = new SecretListEntry([
                ...
                'Tags' => empty($item['Tags']) ? null : $this->populateResultTagListType($item['Tags']),
                'SecretVersionsToStages' => empty($item['SecretVersionsToStages']) ? null : $this->populateResultSecretVersionsToStagesMapType($item['SecretVersionsToStages']),
