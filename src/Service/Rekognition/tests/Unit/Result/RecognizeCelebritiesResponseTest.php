...
class RecognizeCelebritiesResponseTest extends TestCase
{
    public function testRecognizeCelebritiesResponse(): void
    {
        ...
        $result = new RecognizeCelebritiesResponse(new Response($client->request('POST', 'http://localhost'), $client, new NullLogger()));

         self::assertSame(1, $result->getCelebrityFaces());
         self::assertSame(1, $result->getUnrecognizedFaces());
    }
}
