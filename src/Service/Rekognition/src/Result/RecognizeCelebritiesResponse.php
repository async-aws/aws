...
class RecognizeCelebritiesResponse extends Result
{
    ...
    private function populateResultCelebrityList(array $json): array
    {
        ...
        foreach ($json as $item) {
            $items[] = new Celebrity([
                'Urls' => empty($item['Urls']) ? null : $this->populateResultUrls($item['Urls']),
                ...
                'Face' => empty($item['Face']) ? null : new ComparedFace([
                    ...
                    'Landmarks' => empty($item['Face']['Landmarks']) ? null : $this->populateResultLandmarks($item['Face']['Landmarks']),
                    ...
                    'Emotions' => empty($item['Face']['Emotions']) ? null : $this->populateResultEmotions($item['Face']['Emotions']),
    ...
    private function populateResultComparedFaceList(array $json): array
    {
        ...
        foreach ($json as $item) {
            $items[] = new ComparedFace([
                ...
                'Landmarks' => empty($item['Landmarks']) ? null : $this->populateResultLandmarks($item['Landmarks']),
                ...
                'Emotions' => empty($item['Emotions']) ? null : $this->populateResultEmotions($item['Emotions']),
