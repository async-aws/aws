...
class CloudWatchClient extends AbstractApi
{
     ...
     * `GetMetricData` operation can also retrieve other metrics. Metrics Insights queries can query the most recent two
     * weeks of metric data. For alarm condition evaluations, Metrics Insights queries can query only the most recent three
