...
class GetVectorBucketPolicyOutputTest extends TestCase
{
    public function testGetVectorBucketPolicyOutput(): void
    {
        ...
        $result = new GetVectorBucketPolicyOutput(new Response($client->request('POST', 'http://localhost'), $client, new NullLogger()));
