...
/**
 * Indicates that a request contains an invalid grant. This can occur if a client makes a CreateToken request with an
 * invalid grant type.
 */
final class InvalidGrantException extends ClientException
{
    /**
