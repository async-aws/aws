...
final class ExecuteStatementRequest extends Input
{
     ...
     *
     * > When you use the CLI on Linux to reference a secret created in the RDS console, the ARN might include special
     * > characters like `rds!cluster`. If you enclose the ARN in double quotes, the `!` character might trigger a shell
     * > expansion error, such as `-bash: !cluster: event not found`. To avoid this, escape the exclamation mark (\!) in the
