        ...
        foreach ($json as $item) {
            $items[] = new FunctionConfiguration([
                ...
                'VpcConfig' => empty($item['VpcConfig']) ? null : new VpcConfigResponse([
                    'SubnetIds' => empty($item['VpcConfig']['SubnetIds']) ? null : $this->populateResultSubnetIds($item['VpcConfig']['SubnetIds']),
                    'SecurityGroupIds' => empty($item['VpcConfig']['SecurityGroupIds']) ? null : $this->populateResultSecurityGroupIds($item['VpcConfig']['SecurityGroupIds']),
                ...
                'Environment' => empty($item['Environment']) ? null : new EnvironmentResponse([
                    'Variables' => empty($item['Environment']['Variables']) ? null : $this->populateResultEnvironmentVariables($item['Environment']['Variables']),
                ...
                'Layers' => empty($item['Layers']) ? null : $this->populateResultLayersReferenceList($item['Layers']),
                ...
                'FileSystemConfigs' => empty($item['FileSystemConfigs']) ? null : $this->populateResultFileSystemConfigList($item['FileSystemConfigs']),
                ...
                'ImageConfigResponse' => empty($item['ImageConfigResponse']) ? null : new ImageConfigResponse([
                    'ImageConfig' => empty($item['ImageConfigResponse']['ImageConfig']) ? null : new ImageConfig([
                        'EntryPoint' => empty($item['ImageConfigResponse']['ImageConfig']['EntryPoint']) ? null : $this->populateResultStringList($item['ImageConfigResponse']['ImageConfig']['EntryPoint']),
                        'Command' => empty($item['ImageConfigResponse']['ImageConfig']['Command']) ? null : $this->populateResultStringList($item['ImageConfigResponse']['ImageConfig']['Command']),
