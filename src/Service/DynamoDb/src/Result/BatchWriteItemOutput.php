    ...
    private function populateResultItemCollectionMetricsMultiple(array $json): array
    {
        ...
        foreach ($json as $item) {
            $items[] = new ItemCollectionMetrics([
                'ItemCollectionKey' => empty($item['ItemCollectionKey']) ? null : $this->populateResultItemCollectionKeyAttributeMap($item['ItemCollectionKey']),
                'SizeEstimateRangeGB' => empty($item['SizeEstimateRangeGB']) ? null : $this->populateResultItemCollectionSizeEstimateRange($item['SizeEstimateRangeGB']),
            ]);
        }
